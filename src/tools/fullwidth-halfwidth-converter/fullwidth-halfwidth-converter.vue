...
const output = ref('');
const conversionType = ref<'fullwidth-to-halfwidth' | 'halfwidth-to-fullwidth' | 'hiragana-to-katakana' | 'katakana-to-hiragana' | 'alphabet-to-katakana' | 'katakana-to-alphabet' | 'alphabet-to-hiragana' | 'hiragana-to-alphabet' | 'normalize'>('fullwidth-to-halfwidth');
